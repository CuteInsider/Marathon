...
CREATE TABLE `registrationevent` (
  ...
  CONSTRAINT `registrationevent_ibfk_2` FOREIGN KEY (`EventId`) REFERENCES `event` (`EventId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `registrationevent`
--

LOCK TABLES `registrationevent` WRITE;
/*!40000 ALTER TABLE `registrationevent` DISABLE KEYS */;
/*!40000 ALTER TABLE `registrationevent` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-06-18 15:55:16
